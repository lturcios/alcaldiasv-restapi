INSERT INTO `contribuyente` (contrib_id, dui, nit, apellidos, codigo_cta, departamento, direccion, fecha_creacion,
                             institucion_id, municipio_id, nombres, telefono_principal, telefono_secundario)
VALUES (null, '12345678-9', null, 'Turcios', 123, 'San Miguel', 'En algun lugar de San Miguel', null, '1', '100',
        'Luis', '75491235', null);

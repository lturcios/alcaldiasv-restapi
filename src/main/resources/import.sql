INSERT INTO `contribuyente` (dui, direccion, departamento, largo_local, ancho_local, nombre, impuesto) VALUES ('12345678-9', 'En algun lugar de SM', 'San Miguel', 10.4, 20.0, 'Fernando Alvarado', 4.0);
